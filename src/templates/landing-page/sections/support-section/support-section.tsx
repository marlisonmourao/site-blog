...
export function SupportSection() {
  return (
    <section className="relative pb-8 md:py-10 bg-gradient-to-r from-gray-500">
      <div className="absolute inset-0 hidden md:block bg-[url('/background-features.svg')] bg-cover bg-center bg-no-repeat opacity-90" />

      <div className="flex flex-col items-center gap-12 container relative">
        <h2
          className={
            'font-sans text-balance text-center text-heading-xl text-gray-100'
          }
        >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
            ...
            <p className="text-body-sm text-gray-100">
              Não importa a loja, o Site.Set permite que você poderá inserir
              qualquer link de afiliado.
            </p>
          </div>
